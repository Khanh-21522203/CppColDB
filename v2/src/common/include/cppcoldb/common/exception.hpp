...
public:
    explicit CppColDBException(std::string msg) : message_(std::move(msg)) {}
...
public:
    explicit ParseError(std::string msg, std::size_t pos = std::string::npos)
...
public:
    explicit BindError(std::string msg) : CppColDBException(std::move(msg)) {}
...
public:
    explicit RuntimeError(std::string msg) : CppColDBException(std::move(msg)) {}
...
public:
    explicit IOError(std::string msg) : CppColDBException(std::move(msg)) {}
    std::string Type() const override { return "IOError"; }
};

#define THROW_PARSE_ERROR(msg, pos) throw ::cppcoldb::common::ParseError((msg), (pos))
#define THROW_BIND_ERROR(msg)       throw ::cppcoldb::common::BindError(msg)
#define THROW_RUNTIME_ERROR(msg)    throw ::cppcoldb::common::RuntimeError(msg)
#define THROW_IO_ERROR(msg)         throw ::cppcoldb::common::IOError(msg)
